...
export const Leaderboard = () => {
  ...
  // TODO: Replace with a global theming handler later
  ...
  const isPending =
    isPendingLeaderBoard || isPendingViewer || isPendingLeaderBoardViewerState;

  useEffect(() => {
    setHeaderColor("#03277e");
    hide();
    dispatch(leaderboardModel.thunks.fetch({ page: 1 }));
