...
export const ModalDownload: React.FC<ModalDownloadProps> = ({
  ...
  const { data, isPending, ios, android, apk } = useSelector(
    (state: RootState) => ({
  ...
  // TODO: replace with wallet-aware deep linking / web-based handler
  ...
  return (
    <Modal title={"Link Wallet"} isOpen={isOpen} setIsOpen={setIsOpen}>
      <p className={styles.description}>
        To connect OORT Wallet, download DataHub mobile application and link
        this account using a unique code
      </p>
