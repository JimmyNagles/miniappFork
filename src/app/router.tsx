  ...
  return (
    ...
    >
      <Routes location={displayLocation}>
        ...
        <Route path={RouterPathes.POINTS} element={<PointsInfo />} />
        <Route path={RouterPathes.REFERRALS} element={<Referrals />} />
        <Route path={RouterPathes.CHALLENGES} element={<Challenges />} />
        <Route path={RouterPathes.LEADERBOARD} element={<Leaderboard />} />
        <Route
          path={RouterPathes.TOTAL_REFERRALS}
          element={<ReferralsInfo />}
        />
        <Route path={RouterPathes.PHOTO_TASK} element={<ImageTask />} />
        <Route path={RouterPathes.VIDEO_TASK} element={<VideoTask />} />
        <Route path={RouterPathes.AUDIO_TASK} element={<AudioTask />} />
        <Route path={RouterPathes.TRANSACTIONS} element={<Transactions />} />
        <Route path={RouterPathes.VALIDATION} element={<Validation />} />
        <Route path={RouterPathes.ON_BOARDING} element={<OnBoarding />} />
      </Routes>
    </div>
  );
});
