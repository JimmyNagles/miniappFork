...
const TaskResponseComponent: React.FC<TaskResponseProps> = ({ award }) => {
  // TODO: implement setHeaderColor (e.g., theme context or layout override)
  ...
  return createPortal(
    <div className={[styles.root, styles.container].join(" ").trim()}>
      <div className={styles.content}>
        <img src={icons.response} width={140} height={140} alt="response" />
        ...
        <div className={styles.cell}>
          <div className={styles["row-between"]}>
            <div className={styles.row}>
              <Icon name={"coin"} view={"surface"} size={20} />
              <p>Reward</p>
            </div>
            <p className={styles.reward}>+{award} Points</p>
          </div>
          <p className={styles.description}>
            If the task is completed correctly you will receive your points
            within 24 hours
          </p>
        </div>
      </div>
      ...
      <ReferralModal isOpen={isOpen} setIsOpen={close} />
    </div>,
    document.body
  );
};
